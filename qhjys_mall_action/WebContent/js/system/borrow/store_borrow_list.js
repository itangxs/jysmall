...
function addnewcredit(){
	var wxstoreid = document.getElementById("wxstoreid").value;
	var storeName = document.getElementById("storeName").value;
	window.location.href = "/managermall/systemmall/borrow/addborrowinfo.do?storeId="+wxstoreid+"&storeName="+storeName;
}
...
function updateStatus(c) {
	...
	if (f.length > 0) {
		if (confirm("修改状态?")) {
			var b = "/managermall/systemmall/borrow/updatecreditstatus.do";
