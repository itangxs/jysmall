...
//	uploadFile($('#update4'), $("#img4"), $("#img4u"));
	$("#taskType").on("change",function(){
		if ($("#taskType").val()==4) {
			$("#renwubianhao").html("商家编号");
			$("#propass").show();
			$("#projectUrl").attr("readonly","readonly");
			$("#projectUrl").val("/appUser/task/goSellerTask.do?sellerId="+$("#project").val()+"&userId=");
		}else{
			$("#renwubianhao").html("任务编号");
			$("#propass").hide();
			$("#propass").val();
			$("#projectUrl").removeAttr("readonly");
			$("#projectUrl").val("");
		}
	});
