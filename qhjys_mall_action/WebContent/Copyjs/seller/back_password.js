$(document).ready(function() {
	 ...
	 $("#phone").formValidator({onShow:"请输入手机号码",onFocus:"输入中...",onCorrect:""}).inputValidator({min:11,max:11,onError:"位数错误"}).regexValidator({regExp:"mobile",dataType:"enum",onError:"格式错误"});
