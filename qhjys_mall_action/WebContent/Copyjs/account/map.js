    ...
    //标注点数组
    var markerArr = [{title:title,content:content,point:longitude+"|"+latitude,isOpen:0,icon:{w:21,h:22,l:45,t:45,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
        for(var i=0;i<markerArr.length;i++){
            ...
            label.setStyle({ width:"300px",height:"30px",
                        borderColor:"#808080",
                        color:"#ff0000",font:"18px",
                        cursor:"pointer"
            });
