...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/adminuser/uLeft.jsp" flush="true"  ><jsp:param name="val" value="3" /></jsp:include>
    <!--------------右侧------------------>
	<!--------------右侧------------------>
		<div class="memberright">
			<h3 style="padding-left: 10px; margin-bottom: 25px;">权限菜单组列表</h3>
			<div class="member_myorder">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<th class="td160">菜单名称</th>
						<th class="td160">修改</th>
					</tr>
					<c:forEach items="${roleMenuList }" var="roleMenu" >
					<tr>
						<td class="td160">${roleMenu.name}</td>
						<td class="td160"><a href="/managermall/systemmall/userrole/addRole.do?id=${roleMenu.id}">修改</a></td>
					</tr>					
					</c:forEach>
				</table>
			</div>
