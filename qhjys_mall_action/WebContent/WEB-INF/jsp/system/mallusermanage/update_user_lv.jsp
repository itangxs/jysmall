...
<script type="text/javascript" src="/js/system/mallusermanage/update_user_lv.js"></script>
...
<div class="membercontent">
	...
	<div class="memberright">
     <h3 style="padding-left:10px; margin-bottom:25px;">会员管理——添加会员等级</h3>
          ...
          <form action="/managermall/systemmall/malluser/updateUserLv.do"  id="signupForm" method="post">
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="td160">
                    	<input name="name" id="name" value="${u.lvName}"><span id="nameTip"></span>
                    </td>
                     <td class="td160">
                    	<img  id="img1"  src="${u.lvImage }" width="150" height="120" alt="" />
			        	<input type="hidden" id="img1u" name="imgs" value="${u.lvImage}"/>
			        	<input  class="uploadify" type="file" value="上传" id="update1"/></p> 
			        	<span id="imgsTip"></span>
                    </td>
                    
                     <td class="td160">
                    	<input name="min" id="min" value="${u.minIntegral }">
                    	<span id="minTip"></span>
                    </td>
                    
                     <td class="td160">
                    	<input name="max" id="min" value="${u.maxIntegral }">
                    	<span id="minTip" ></span>
                    </td>
               ...
               <div class="td160">
                  	  ...
                  	  <input type="hidden" name="token" value="${updateLvToken}">
