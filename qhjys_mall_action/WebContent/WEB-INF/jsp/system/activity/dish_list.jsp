...
<div class="membercontent">
	...
	<div class="memberright">
     <h3 style="padding-left:10px; margin-bottom:25px;">活动管理——活动菜品列表</h3> 
       <form id="from" name="form" action="/managermall/systemmall/activity/dish_list.do" method="post">
    	  	<input id="page" name="page" type="hidden" value="${page.getPageNum()}">
        </form>
          <div class="member_myorder">
          	<input type="button" value="添加菜品" class="tanchubutton"  onclick="javascript:window.location.href='/managermall/systemmall/activity/add_dish_page.do'">
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <th class="td160">ID</th>
                    <th class="td160">活动</th>
                    <th class="td160">奖项等级</th>
                    <th class="td160">菜品名称</th>
                    <th class="td160">菜品图片</th>
                    <th class="td160">菜品说明</th>
                    <th class="td160">兑现人数</th>
                ...
                <tr>
	                ...
	                <td class="td160"> 
	                	<c:forEach items="${lotterys}" var="store">
	                		<c:if test="${ai.lotteryId==store.id}">${store.lotteryName}</c:if>
	                   	</c:forEach>
	                   </td>
                    <td class="td160">
                    	${ai.rankLevel}
                    ...
                    <td class="td160"><a href="/managermall/systemmall/activity/update_dish_page.do?id=${ai.id}">修改</a></td>
                </tr>
              </c:forEach>
