...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/product/uLeft.jsp" flush="true" ><jsp:param name="val" value="7" /></jsp:include>
    <!--------------右侧------------------>
	<!--------------右侧------------------>
	<div class="memberright">
     <h3 style="padding-left:10px; margin-bottom:25px;">活动管理——消费卷验证记录列表</h3> 
       <form id="from" name="form" action="/managermall/systemmall/activity/virify_list.do" method="post">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <th class="td160">消费卷ID</th>
                    <th class="td160">消费时间</th>
                </tr>
              <c:forEach items="${page}" var="ai">
                <tr>
                    <td class="td160">${ai.id}</td>
                    <td class="td160">${ai.storeId}</td>
                    <td class="td160">${ai.couponsId}</td>
                    <td class="td160">
                   		 <fmt:formatDate value="${ai.verifyTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                    </td>
                </tr>
              </c:forEach>
