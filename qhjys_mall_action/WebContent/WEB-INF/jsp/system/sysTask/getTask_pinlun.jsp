	...
	<div class="memberright">
          ...
          <p class="clearfix">
        	<label class="textw100" for="con-email4" >达标评价星级数:</label>
        		<c:if test="${task.appraiseRank ==1 }">1星</c:if>
        		<c:if test="${task.appraiseRank ==2 }">2星</c:if>
        		<c:if test="${task.appraiseRank ==3 }">3星</c:if>
                <c:if test="${task.appraiseRank ==4 }">4星</c:if>
        		<c:if test="${task.appraiseRank ==5 }">5星</c:if>
          </p>
        	<p class="clearfix">
