...
<div class="membercontent">
	...
	<div class="memberright">
          ...
          <p class="clearfix">
           ...
           <p class="clearfix">
        	<label class="textw100" for="con-email4">appid:</label>
        	<input class="con-email" name="appid" value="" id="appid"/>必须填写正确
          </p>
           <p class="clearfix">
        	<label class="textw100" for="con-email4">secret:</label>
        	<input class="con-email" name="secret" value="" id="secret"/>必须填写正确
          </p>
          <p class="clearfix">
