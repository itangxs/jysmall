...
<div class="membercontent">
	...
	<div class="memberright">
     <h3 style="padding-left:10px; margin-bottom:25px;">消息反馈</h3> 
    	  <form id="from" name="form1" action="/managermall/systemmall/feedback/feedbackPage.do" method="post">
        ...
        <p class="clearfix">    
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <th class="td160">意见内容</th>
                    <th class="td160">提交时间</th>
                    <th class="td160">商家ID</th>
                    <th class="td160">商家名称</th>
                </tr>
              
              <c:forEach items="${page}" var="fee">
              
                <tr>
                    <td class="td160">${fee.title}</td>
                    <td class="td160">${fee.content}</td>
                    <td class="td160"><fmt:formatDate value="${fee.feedbackTime}" pattern="yyyy-MM-dd hh:mm"/></td>
                    <td class="td60">${fee.storeId}</td>
                    <td class="td160">${fee.storeName}</td>
