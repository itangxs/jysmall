...
<div class="membercontent">
	...
	<div class="memberright">
     <h3 style="padding-left:10px; margin-bottom:25px;">APP推送——发送消息历史</h3> 
    	  <form id="from" name="form1" action="/managermall/systemmall/message/pushPage.do" method="post">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <c:forEach items="${page}" var="mes">
                ...
                <tr>
                    ...
                    <td class="td160">${mes.content}</td>
                    <td class="td160"><fmt:formatDate value="${mes.pushTime}" pattern="yyyy-MM-dd hh:mm"/></td>
                </tr>
              </c:forEach>
              </table>
            </div>
