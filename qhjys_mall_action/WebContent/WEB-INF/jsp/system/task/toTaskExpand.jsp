...
<div class="membercontent">
	...
	<div class="memberright">
            <h3 style="padding-left:10px; margin-bottom:25px;">修改说明</h3>  
            <form id="form1" name="form1"  class="zcform1" action="/managermall/systemmall/task/updateTaskExpand.do" method="post">
           
          <p class="clearfix">
        	<label class="one" for="con-email4" >步&nbsp;&nbsp;	骤   &nbsp;&nbsp;:</label>
        	<input class="con-email4" name="step" id="step" value="${taskExpand.step}"/>(请填写数字,比如1 2 3 ..)
          </p>
          
          <p class="clearfix">
        	<label class="one" for="con-email4" >奖励要求:</label>
        	<textarea class="con-email4" name="requirements" id="requirements" cols="70" rows="4">${taskExpand.requirements}</textarea>
          </p>
          
          <p class="clearfix">
        	<label class="one" for="con-email4" >奖励元宝:</label>
        	<input class="con-email4" name="prize" id="prize" value="${taskExpand.prize}"/>
          </p>
          	<input type="hidden" name="taskId" value="${taskExpand.taskId}">
          	<input type="hidden" name="id" value="${taskExpand.id}">
