...
<script type="text/javascript" src="/js/system/borrow/all_wxstore_list.js"></script>
</head>
<body>
...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/borrow/borrowLeft.jsp"><jsp:param name="position"  value="3"/></jsp:include>
	<!-- end -->
		<div class="memberright">
             <h3 style="padding-left:10px; margin-bottom:25px;">借贷管理——微信店铺列表</h3>
        <form id="from"  class="zcform1" method="post" action="/managermall/systemmall/borrow/wxstorelist.do">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <c:forEach items="${page}" var="s">
                <tr>
                    ...
                    <td class="td160">
                    <button onclick="javascript:window.location.href='/managermall/systemmall/borrow/addborrowinfo.do?storeId=${s.id}&storeName=${s.storeName}'">添加借贷信息 </button>
                </tr>
                </c:forEach>
              </table>
            </div>
