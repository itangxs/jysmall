...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/borrow/borrowLeft.jsp"><jsp:param name="position"  value="2"/></jsp:include>
	<!-- end -->
	<div class="memberright">
             <h3 style="padding-left:10px; margin-bottom:25px;">借贷管理——借贷列表</h3>
        <form id="from"  class="zcform1" method="post" action="/managermall/systemmall/borrow/allborrowlist.do">
        ...
        <div class="member_myorder">
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <th class="td100">期数</th>
                    <th class="td120">借款金额</th>
                    <th class="td120">未还金额</th>
                    <th class="td100">负责人</th>
                    <th class="td120">负责人电话</th>
                    <th class="td120">启用状态</th>
                </tr>
              <c:forEach items="${page}" var="c">
                <tr>
                    <td class="td120">${c.storeName}</td>
                    <td class="td100">${c.period}</td>
                    <td class="td120">${c.creditMoney}</td>
                    <td class="td120">${c.noRevert}</td>
                    <td class="td100">${c.principal}</td>
                    <td class="td120">${c.principalPhone}</td>
                    <td class="td120">
