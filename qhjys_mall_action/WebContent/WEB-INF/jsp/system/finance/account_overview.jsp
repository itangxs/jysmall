...
<div class="membercontent">
	...
	<div class="memberright">
        ...
        <p class="clearfix">
	        ...
	        <label class="one" for="con-email2" style="font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商家未结算金额：</label>    
	        <span  style="font-size:16px; color:#F60">￥${weijiesuan }</span>        
      	<!--<span style="margin-left:200px;">免费提现额度：￥200,000.00元</span> -->
      	<form action="/managermall/systemmall/finance/sellerBalanceRecordList.do?sellerId=${cash.accountId }"  method="post" id="from">
		...
		<input style="position:absolute;left:800px;" type="button" value="返回" class="submit6" onclick="location='/managermall/systemmall/finance/sellerWithdrawsRecordList.do'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div class="member_myorder">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
           		<tr>
                	<th colspan="4" style="font-size:15px;">资金流水表</th>
                </tr>
                <tr>
                    <th>日期</th>
                    <th>流动资金</th>
