...
<script type="text/javascript" src="/js/system/ad/acard_create.js"></script>
</head>
<body>
<!-------------------top---------------------------------------------------------------------->
...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/message/uLeft.jsp" flush="true" ><jsp:param name="position" value="10" /></jsp:include>
	<!--------------右侧------------------>
	<div class="memberright">
     <h3 style="padding-left:10px; margin-bottom:25px;">新建商家卡券</h3>
            <div class="content">
            <form id="from" method="post" action="/managermall/systemmall/ad/acard_add.do">
					<div class="contact-box">
                        ...
                        <div class="right-part">
                         	<input class="activity" type="text" name="acardName">
                        </div>
                        <div class="clearfix"></div>
    				</div>
       			 	<div class="contact-box">
        			...
        			<div class="contact-box">
                        ...
                        <div class="right-part">
                          <div class="period">	
                         	<input id="begin" name="beginDate" class="easyui-datebox con-time" style="height:33px; width:140px;">
                            <label class="to">至</label>
                            <input id="ending" name="endDate" class="easyui-datebox con-time" style="height:33px; width:140px;">
                          </div>
                        </div> 
                        <div class="clearfix"></div>
    				</div>
        			...
        			<div class="contact-box">
                         ...
                         <div class="right-part">
                         	<div class="lottery">
         						<span>单一微信账号每天可推送次数为</span>
          					    <input class="number" type="text" name="pushNum" onkeyup="value=value.replace(/[^(\d)]/g,'')" />
           					    <span>次</span>
							</div>
                         </div> 
                         <div class="clearfix"></div>
                     ...
                     <div class="contact-box">
                         ...
                         <div class="right-part">
                         	 ...
                         	 onkeyup="www_zzjs_net(this.form.memo,this.form.remLen,15)" 
                ...
                消费满&nbsp;&nbsp;<input class="con-email3" maxlength="15" name="prizeLine" >&nbsp;&nbsp;元即可使用<span class="colorgray">&nbsp;&nbsp;注：(金额必须填整数)</span>    
                 </p>                       
                      <div class="contact-box">
                    	 <div class="left-part">    
    				    	 <label>描述：</label>
                         ...
                         <div class="right-part">
                         	  ...
                         	  name="prizeDesc" cols="45" rows="8" wrap="on"></textarea><span class="notice">注：(最多不可超过60字)</span>
                         </div>
                         <div class="clearfix"></div>
                      </div>           		 
                     <div class="contact-box2">
                    	<div class="right-part">
    						<img  id="img1" src="" width="348" height="224" alt="" />
                    		<input type="hidden" id="img1u" name="imgs" value=""/>
             			</div>
             			<input type="file" value="上传图片" id="update1" />
                        <div class="clearfix"></div>
                      </div>
                     ...
                     <div class="contact-box">
                    	<div class="left-part">   
                         ...
                         <div class="right-part">
                         	 <input class="name" onkeydown="www_zzjs_net(this.form.memo,this.form.remLen,15)" 
                         	 onkeyup="www_zzjs_net(this.form.memo,this.form.remLen,15)" 
                         	 name="prizeName" cols="45" rows="8" wrap="on"><span class="notice">
                    ...
                    消费满&nbsp;&nbsp;<input class="con-email3" maxlength="15"  name="prizeLine" >&nbsp;&nbsp;元即可使用<span class="colorgray">&nbsp;&nbsp;注：(金额必须填整数)</span>    
                      ...
                      <div class="contact-box">
                       ...
                       <div class="contact-box2">
                    	<div class="right-part">
    						<img  id="img2" src="" width="348" height="224" alt="" />
                    		<input type="hidden" id="img2u" name="imgs" value=""/>
             			</div>
             			<input type="file" value="上传图片" id="update2" />
                        <div class="clearfix"></div>
                      </div> 
                     ...
                     <div class="contact-box">
                    	<div class="left-part">   
                         ...
                         <div class="right-part">
                         	 <input class="name" onkeydown="www_zzjs_net(this.form.memo,this.form.remLen,15)" 
                         	 onkeyup="www_zzjs_net(this.form.memo,this.form.remLen,15)" 
                         	 name="prizeName" cols="45" rows="8" wrap="on"><span class="notice"><span class="notice">注：(最多不可超过15字)</span>
                        </div>
                        <div class="clearfix"></div>
                      </div> 
                      <p class="clearfix" style="margin:-10px 0 20px 0;">
                ...
                消费满&nbsp;&nbsp;<input class="con-email3" maxlength="15"  name="prizeLine" >&nbsp;&nbsp;元即可使用<span class="colorgray">&nbsp;&nbsp;注：(金额必须填整数)</span>    
                      ...
                      <div class="contact-box">
                        ...
                        <div class="contact-box2">
                    	<div class="right-part">
    						<img  id="img3" src="" width="348" height="224" alt="" />
                    		<input type="hidden" id="img3u" name="imgs" value=""/>
             			</div>
             			<input type="file" value="上传图片" id="update3" />
                        <div class="clearfix"></div>
                      </div> 
                ...
                消费满&nbsp;&nbsp;<input class="con-email3" maxlength="15" name="prizeLine">&nbsp;&nbsp;元即可使用<span class="colorgray">&nbsp;&nbsp;注：(金额必须填整数)</span>    
            		 ...
            		 <div class="contact-box2">
                    	<div class="right-part">
    						<img  id="img4" src="" width="348" height="224" alt="" />
                    		<input type="hidden" id="img4u" name="imgs" value=""/>
             			</div>
             			<input type="file" value="上传图片" id="update4" />                      
                        <div class="clearfix"></div>
                      </div> 
            		 ...
            		 <div class="contact-box">
                         ...
                         <div class="right-part">
                         	   <div class="setting1">
   									<div class="set01">
   										<label>卡券1概率：</label>
                                        <input name="probability" type="text" onkeyup="if(isNaN(value))execCommand('undo')" 
