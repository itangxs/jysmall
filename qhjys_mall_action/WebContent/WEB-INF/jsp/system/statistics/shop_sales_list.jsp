...
<script type="text/javascript" src="/js/system/statistics/shop_sales_list.js"></script>
...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/statistics/uLeft.jsp" flush="true" ><jsp:param name="position" value="4" /></jsp:include>
    <!--------------右侧------------------>
	<div class="memberright">
        <h3 style="padding-left:10px; margin-bottom:25px;">店铺销售额统计</h3>
           <form id="from" method="post" action="/managermall/systemmall/statistics/shopSalesList.do">
