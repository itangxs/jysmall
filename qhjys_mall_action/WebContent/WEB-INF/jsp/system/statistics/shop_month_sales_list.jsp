...
<script type="text/javascript" src="/js/system/statistics/shop_month_sales_list.js"></script>
</head>
...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/statistics/uLeft.jsp" flush="true" ><jsp:param name="position" value="6" /></jsp:include>
    <!--------------右侧------------------>
	<div class="memberright">
        <h3 style="padding-left:10px; margin-bottom:25px;">店铺月销售报表</h3>
           <form id="from" method="post" action="/managermall/systemmall/statistics/shopMonthSalesList.do">
           ...
           <p class="clearfix">
        	...
        	<label class="one" for="con-email4" >月份：</label>
        	<input id="begin" name="monthStart" class="easyui-datebox con-time" value="${monthStart}">
			<label class="one" for="con-email2">-</label>
			<input id="ending" name="monthEnd" class="easyui-datebox con-time" value="${monthEnd}">
             </p>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="td160"><fmt:formatDate value="${s.date}" pattern="yyyy年MM月份"/></td>
