...
<script type="text/javascript" src="/js/system/statistics/shop_day_sales_list.js"></script>
</head>
...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include page="/WEB-INF/jsp/system/statistics/uLeft.jsp" flush="true" ><jsp:param name="position" value="5" /></jsp:include>
    <!--------------右侧------------------>
	<div class="memberright">
        <h3 style="padding-left:10px; margin-bottom:25px;">店铺每日销售报表</h3>
           <form id="from" method="post" action="/managermall/systemmall/statistics/shopDaySalesList.do">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="td160"><fmt:formatDate value="${s.date}" pattern="yyyy-MM-dd HH:mm"/></td>
