...
<!--请朋友帮忙按钮-->
<div class="help_button"> <a href="javascript:void(0)" onclick="document.getElementById('fenxiang').style.display='block'; document.getElementById('fade').style.display='block'"><img src="/images/a-friendhelp.png"></a>
  </div>
<!--中奖弹出层-->
