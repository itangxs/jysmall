  ...
  <div class="tanchubox">
    ...
    <div class="tanchu_content">  
    	<div class="zhongjiangbox">
            ...
            <div class="buttonbkbox"><input onclick="document.getElementById('zhongjiang').style.display='none';document.getElementById('fenxiang').style.display='block'; document.getElementById('fade').style.display='block'" class="button60k" name="" type="submit" value="请朋友帮忙抽"><input onclick="document.getElementById('zhongjiang').style.display='none';document.getElementById('fade').style.display='none'" class="button40k" name="" type="submit" value="我知道了"></div>
          </c:if>
          <c:if test="${isShare==1}">
...
<div id="mashangduihuan" class="white_content">
  <div class="tanchubox">
  	<a href="javascript:void(0)"  onclick="document.getElementById('mashangduihuan').style.display='block';document.getElementById('fade').style.display='none'"><img class="img100" src="images/a-duihuantop.png" ></a>
    <div class="tanchu_content">
        <div class="tc_dhq">
            <div class="left">
