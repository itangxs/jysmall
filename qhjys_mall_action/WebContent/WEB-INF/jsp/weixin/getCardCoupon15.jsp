...
<input type="hidden" name="userLotteryId" value="${userLotteryId }">
  ...
  <input type="hidden" name="forOpenId" value="${forOpenId }">
    <input type="hidden" name="id">
     <c:if test="${isShare==0 }">
	 <c:if test="${not empty cardCouponTemplate }">
	 <div  id="zjtbdiv"  class="text1">恭喜您获得
		 <c:if test="${obj.cardCouponTemplate == 2}">折扣券</c:if>
		 <c:if test="${obj.cardCouponTemplate == 1}">代金券</c:if>
		 <c:if test="${obj.cardCouponTemplate == 0}">礼品券</c:if>
	<p>【${cardCouponTemplate.name }】</p></div>
	 </c:if>
	 <c:if test="${ empty cardCouponTemplate }">
<div id="zjtbdiv" class="text1"><p>&nbsp;</p></div>
</c:if>
</c:if>
<body class="a_zhuanpanbg">
<div class="wrapper">
 <c:if test="${isShare==1 }">
 <div class="help-title"><div class="bg">助力好友【${fquser.nickName }】抽取兑换券</div></div>
 </c:if>
  <!--转盘-->
  <div class="ly-plate">
...
<!--请朋友帮忙按钮-->
 ...
 <div class="help_button"> <a href="javascript:void(0)" onclick="document.getElementById('fenxiang').style.display='block'; document.getElementById('fade').style.display='block'"><img src="/images/a-friendhelp.png"></a></div></c:if>
   <c:if test="${isShare==1}">
   <div class="help_button"><a href="javascript:void(0)" onclick="location.href='/wxMall/jump/getCardCoupon.do?flag=${statusCfg }&sellerId=${sellerId}&orderId=${orderId}'"><img src="/images/a-share.png"></a></div>
	</c:if>
<!--中奖弹出层-->
<div id="zhongjiang" class="white_content">
  <div class="tanchubox">
  	<a href="javascript:void(0)"  onclick="document.getElementById('zhongjiang').style.display='none';document.getElementById('fade').style.display='none'"><img class="img100" src="/images/a-zhongjiang.png" ></a> 
    <div class="tanchu_content">  
    	<div class="zhongjiangbox">
    	 <c:if test="${isShare==0}">
        	<p>恭喜你颜值爆表，抽到了一张</p>
            <h1></h1>
            <div><input onclick="document.getElementById('zhongjiang').style.display='none';document.getElementById('mashangduihuan').style.display='block'; document.getElementById('fade').style.display='block'" class="buttonred100" name="" type="submit" value="马上兑换"></div>
            <h2>提示：<br>如果对抽到的奖品不满意，可以转发邀请朋友帮忙抽！</h2>
            <div class="buttonbkbox"><input onclick="document.getElementById('zhongjiang').style.display='none';document.getElementById('fenxiang').style.display='block'; document.getElementById('fade').style.display='block'" class="button60k" name="" type="submit" value="请朋友帮忙"><input onclick="document.getElementById('zhongjiang').style.display='none';document.getElementById('fade').style.display='none'" class="button40k" name="" type="submit" value="我知道了"></div>
        </c:if>
         <c:if test="${isShare==1}">
        <p>恭喜你颜值爆表，帮好友抽到了一张</p>
             <h1></h1>
            <p></p>
            <div><input onclick="location.href='/wxMall/jump/getCardCoupon.do?flag=${statusCfg }&sellerId=${sellerId}&orderId=${orderId}'" class="buttonred100" name="" type="submit" value="我也要参与"></div> 
       </c:if> </div>      
    </div>          
  </div>
</div>
...
<div id="weiguanzhu" class="white_content">
  <div class="tanchubox">
  	<a href="javascript:void(0)"  onclick="document.getElementById('weiguanzhu').style.display='none';document.getElementById('fade').style.display='none'"><img class="img100" src="/images/a-weiguanzhu.png" ></a> 
    <div class="tanchu_content">  
...
<div id="duihuan" class="white_content">
  <div class="tanchubox">
  	<a href="javascript:void(0)"  onclick="document.getElementById('duihuan').style.display='none';document.getElementById('fade').style.display='none'"><img class="img100" src="/images/a-duihuantop.png" ></a> 
    <div class="tanchu_content">
        <div class="tc_dhq">
            <div class="left">
            	<span><img  id="img" class="" src="/images/dui-pic3.png" ></span>
            </div>
            <div class="right">
        ...
        <a href="javascript:;" onclick="document.getElementById('duihuan').style.display='none';document.getElementById('fade').style.display='none'"><img class="img100" src="/images/a-kabaozhiyin.jpg" ></a>
    </div>          
  </div>
</div>
<!--马上兑换弹出层-->
<div id="mashangduihuan" class="white_content">
  <div class="tanchubox">
  	<a href="javascript:void(0)"  onclick="document.getElementById('mashangduihuan').style.display='none';document.getElementById('fade').style.display='none'"><img class="img100" src="/images/a-duihuantop.png" ></a> 
    <div class="tanchu_content">
        <div class="tc_dhq">
            <div class="left">
            	<span><img  id="img" class="" src="/images/dui-pic3.png" ></span>
        ...
        <a href="javascript:;" onclick="document.getElementById('mashangduihuan').style.display='none';document.getElementById('fade').style.display='none'"><img class="img100" src="/images/a-kabaozhiyin.jpg" ></a>
    </div>          
  </div>
</div>
<!--弹出幕布-->
  ...
  <div class="jiangpinlist a_rafflebg">
  	...
  	<c:forEach var="m" items="${friendMap }">
		...
		<div class="duihuanbox">
			...
			<div class="rightbox">
	        	<c:if test="${isShare==0}"><p><a href="javascript:void(0)" onclick="duihuan('${m.key}',${m.value[0]['templateId'] },${m.value[0]['couponCfg'] },${m.value[0]['lotteryId'] },'${m.value[0]['openId'] }')"><img src="/images/a-duihuan.png"></a></p></c:if>
	    	</div>
	        <div class="clear"></div>
	    </div>	
	</c:forEach>
