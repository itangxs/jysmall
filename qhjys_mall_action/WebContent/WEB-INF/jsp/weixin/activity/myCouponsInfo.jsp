  ...
  <div class="probox">
  	<ul>
  			...
  			<c:forEach items="${lotterys}" var="lottery">
		    		...
		    		<c:if test="${lottery.id==couponsInfo.lotteryId && flag}">
		    		<a href="/lottery/getCoupons.do?openId=${sessionScope.openId }&lotteryId=${lottery.id}">
		    			<li>
		    				<div class="leftinfo">
			            	<h1><span class="icon"></span>${lottery.storeName}</h1>
			    	...
			    	<c:if test="${flag }">
			    		...
			    		<li>
			    			...
			    			<div class="proimg">
				    				<input class="img1" name=""  type="image" src="/images/weixin/arr01.png">
			    			</div>
			            	<div class="clear"></div>
			       		 </li> </a>
			    	</c:if>
