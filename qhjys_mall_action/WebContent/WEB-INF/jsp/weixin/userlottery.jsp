...
<script src="/js/userlottery.js" type="text/javascript"></script>
...
<div class="wrapper">
  <div class="rafflebox">
  	<div class="buttontop">
    	<ul>
            ...
            <li style=" text-align:right;"><a href="/wxActivity/wxProductlist.do"><input class="buttonright" name="" type="image" src="/images/weixin/buttonbg2.png"></a></li>
            <div class="clear"></div>
        </ul>
    </div>
  ...
  <!--end-->
   <!--提示弹出
  <div class="tanchubox" id="messagetanchu" style="display:none;">
    <div class="tanchu">
        <div class="tishitext">
          <p class="left" id="messagetanchup"></p>
          <p class="right"><a href="javascript:void(0);">确定</a></p>
        </div>
    </div>
  </div>-->
  <!--end-->
  <div class="buttonbox">
      ...
      <li><a href="javascript:fenxiangpyq();"><input class="img90" name="" type="image" src="/images/weixin/buttonbg3.png"></a></li>
      <li style="text-align:right;"><a href="/wxActivity/wxProductlist.do"><input class="img90" name="" type="image" src="/images/weixin/buttonbg4.png"></a></li>
      <div class="clear"></div>
  </ul>
  </div>
  <!--抽奖规则弹出-->
  ...
  <div class="jiangdh">
  	<div class="duihuanbox" style="padding-top:12px;">
		...
		<div class="rightbox">
    		<input  id="sandengjiangbut" class="buttonimg" name="" onclick="duihuanjuan('${ul.id}',4)" type="image" src="/images/weixin/duihuan.png"><!--已兑换状态按钮-->
    	</div>
        <div class="clear"></div>
    </div>
    <div class="duihuanbox">
		...
		<div class="rightbox">
    		<input class="buttonimg"  id="erdengjiangbut" name="" onclick="duihuanjuan('${ul.id}',3)" type="image" src="/images/weixin/duihuan.png"><!--不能兑换状态按钮-->
    	</div>
        <div class="clear"></div>
    </div>
    <div class="duihuanbox">
		...
		<div class="rightbox">
    		<input class="buttonimg"  id="yidengjiangbut" name="" type="image" onclick="duihuanjuan('${ul.id}',2)" src="/images/weixin/duihuan.png"><!--不能兑换状态按钮-->
    	</div>
        <div class="clear"></div>
    </div>
    <div class="duihuanbox">
		...
		<div class="rightbox">
    		<input class="buttonimg"  id="tedengjiangbut" name="" type="image" onclick="duihuanjuan('${ul.id}',1)" src="/images/weixin/duihuan.png"><!--兑换状态按钮-->
    	</div>
        <div class="clear"></div>
    </div>
  </div>  
			 ...
			 { 
				click: function(){
					...
					if(isguanzhu == 0){
						...
						if(already == 1){
							alert("亲~您已经抽过啦！快去分享给小伙伴们继续助力抽大奖吧！");
						}else{
							var iscli = $("#iscli").val();
							if(iscli == 0){
								$("#iscli").val(1);
							$.ajax({
								...
								success: function(data){
									if(data==1){
										rotateFunc(1,0,'天啊~颜值爆表！恭喜您抽中了特等奖！');
									}
									if(data==2){
										rotateFunc(2,90,'哇~人品大爆发！恭喜您抽到了一等奖！');
									}
									if(data==3){
										rotateFunc(3,270,'哎哟~手气不错！恭喜您抽到了二等奖！');
									}
									if(data==4){
										rotateFunc(4,180,'Duang~恭喜您抽到了三等奖！');
									}
