...
<script src="/js/weixin/rebatestore5.js" type="text/javascript"></script>
<script src="/js/weixin/jweixin-1.0.0.js"></script>
<script src="/js/weixin/qqapi.js"></script>
...
<script type="text/javascript" src="/js/weixin/keyboardnew1.js"></script>
