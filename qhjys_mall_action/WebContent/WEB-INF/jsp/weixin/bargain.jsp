...
<body>
<!--分享朋友圈弹出-->
<div class="fenxiangbox" id="fenxiangpyqdiv" style="display:none;" onclick="gbzhaorenbangm()">
...
<div class="wrapper">
  ...
  <div class="probox">
	...
	<div class="proinfo">
        ...
        <div class="buttonbox">
        	<ul>
            	<li><a href="javascript:bangtakanjia('${ub.id }')" class="mright">我要砍价</a></li>
                <li><a href="javascript:zhaorenbangm()" class="mleft">找人帮忙</a></li>
            </ul>
        </div>
        <div class="buttonduihuan"><a href="javascript:mashangduihuan('${ub.nowPrice }')">马上兑换</a></div>
    </div>
    <!--我要砍价弹窗-->
      ...
      <div class="tanchubox" style="display:none;">
        <div class="tanchu">
            <div class="title"><span><a href="#">×</a></span>我要参与</div>
            <div class="tishitext">
    ...
    点击最新活动中的砍价活动即可参与</p>
      ...
      <div class="tanchubox" style="display:none;">
        <div class="tanchu">
            <div class="title"><span><a href="#">×</a></span></div>
            <div class="tishitext">
              <p><span class="ico-cuo"><img src="/images/ico-dui.png" ></span>您已经帮您的好友***砍了<span class="red">2元</span></p>
            </div>
        </div>
      </div>
      <!--end-->
      <!--兑换验证码弹窗-->
      <div class="tanchubox" id="duihuanyzmdiv" style="display:none;">
        <div class="tanchu">
            <div class="title"><span><a href="javascript:guanbimsdh()">×</a></span></div>
            <div class="tishitext">
