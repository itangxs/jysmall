...
<!--请朋友帮忙按钮-->
 ...
 <c:if test="${isShare==0}">
 <div class="help_button"> <a href="javascript:void(0)" onclick="document.getElementById('fenxiang').style.display='block'; document.getElementById('fade').style.display='block'"><img src="/images/b-friendhelp.png"></a></div></c:if>
   <c:if test="${isShare==1}">
   <div class="help_button"><a href="/wxMall/jump/getCardCoupon.do?flag=${statusCfg }&sellerId=${sellerId}&orderId=${orderId}"><img src="/images/b-share.png"></a></div>
	</c:if>
<!--中奖弹出层-->
<div id="zhongjiang" class="white_content">
  <div class="tanchubox">
  	<a href="javascript:void(0)"  onclick="window.location.reload()"><img class="img100" src="/images/a-zhongjiang.png" ></a> 
...
<div class="jiangpinlist b_rafflebg">
	...
	<div class="active-rule" id="active-rule-bc2">
