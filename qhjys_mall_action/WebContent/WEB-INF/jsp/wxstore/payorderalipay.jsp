...
<script type="text/javascript" src="/js/wxstore/alipay.js"></script>
</head>
<body>
 ...
 <div class="content">
 	<ul>
        ...
        <li>
            ...
            <span class="right-float new">¥<fm:formatNumber value="${order.rebateAmount}" type="currency" pattern="0.00"/></span>
            <div class="clearfix"></div>
        </li>
    </ul>
 </div>     
