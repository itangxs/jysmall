...
<body>
<div class="whole-bg">
	<img class="cloud-bg" src="/images/cloud-bg.png">
 
    <div class="lottery-machine">
    
    <img src="/images/lottery-machine5.png">
       
 	
    <div id="pot" style="text-align:center;color:#fff;margin-top:15px;"></div>
    <div class="num_box">
      ...
      <div class="point">
        ...
        <input type="hidden" id="redpackrecordMoney" value="${fpr.redpackMoney }"/>
    </div>
        
        <div class="lottery-times">
        	<h1>你当前剩余的抽取红包次数：<span id="cishu">1</span> 次</h1>
            <p>随机消费即可获得最高199元的随机红包噢！</p>
...
$(function(){
	...
	$('.btn a').click(function(){
		...
		var result = $("#redpackrecordMoney").val()+'';
		if(result.length<5){
			var a='0';
				...
				_num.animate({ 
					...
					complete: function(){
						if(index==4) {
							...
							$.ajax({
								url:"/user/fqorder/doOrderRedpack.do",
								type: "POST",
