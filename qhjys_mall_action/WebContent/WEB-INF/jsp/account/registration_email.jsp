...
<script type="text/javascript" src="/js/account/registration_email.js"></script>
...
<body>
	<div class="loginlogo">
		<span>已有飞券网账号？<a href="login.do" class="button_red">登录</a></span>
	...
	<div class="registration">
		...
		<form id="registrationForm" action="" method="post">
			<c:if test="${sessionScope.nickname != null && sessionScope.nickname !='' }">
			<h1>
				<i>昵称</i> ${sessionScope.nickname }
			</h1></c:if>
			<h1>
				<i>邮箱</i><input class="inputkk"  id="email" name="email" type="text" /><!--红色边框样式inputkkred-->
				<!-- <em>注册成功后，金钥匙通用</em> -->
			</h1>
			<h1>
