...
<div class="membercontent">
    ...
    <div class="memberright">
    	<form action="/managermall/account/rechargeList.do" method="post" id="from">
    		<input type="hidden" id="page" name="page">
    	</form>
    	<div class="memberright_title">我的余额</div>
    	<div class="member_money">
    		<h1>
    			账号金元宝余额：<b class="fontred"><fm:formatNumber value="${sessionScope.userCashAccount.balance}"/></b>
    			<span>
    		...
    		<div class="tabs">
    			<a href="/managermall/account/rechargeList.do" class="tabaction">金元宝交易记录</a>
    			<!-- <a href="/managermall/account/withdrawlist.do">提现记录</a> -->
    			<div class="clear"></div>
            </div>
            <!--充值记录
