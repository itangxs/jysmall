...
<div class="membercontent">
	<!----------------左侧----------------------->
	<jsp:include  page="/WEB-INF/jsp/account/navigation1.jsp"><jsp:param name="position" value="14"/></jsp:include>
    <!--------------右侧------------------>
	...
	<div class="memberright">    
    	<div class="accountindex_left">
   	    ...
   	    <div class="tabs">
    <a href="javascript:void(0)" class="tabaction">金元宝获取记录</a><a href="/managermall/account/myexchange.do">金元宝兑换记录</a>
                <div class="clear"></div>
            </div>
            <div class="centerrenwu" id="jybhqjl" style="display:;">
            	<dl>
                	<dt>
                        ...
                        <span class="width100">获得金元宝</span>
                    </dt>
            ...
            <!--上一页下一页-->
            <div class="page">
                <form action="/managermall/account/myrecharge.do" method="get">
                    <a href="/managermall/account/myrecharge.do?page=${page.getPageNum()-1 }" class="prev">上一页</a>
                    <a href="/managermall/account/myrecharge.do?page=${page.getPageNum()+1 }" class="next">下一页</a>
...
<script type="text/javascript">
	$(function(){
		$("#changebut").click(function(){
			...
			if(pageNum != ""){
				window.location.href="/managermall/account/myrecharge.do?page="+pageNum;
			}
		})
	})
</script>
