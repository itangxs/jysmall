		...
		<div class="topmenu1">     
			...
			<h2>
				<ul>
					...
					<li>
						<i>
							<em>hi，${empty sessionScope.user.realname?sessionScope.user.username:sessionScope.user.realname}</em>
							<a href="/managermall/account/logoutUser.do">退出</a>
						</i>
					</li>
					<li><a href="/managermall/account/order/myOrderForm.do">我的账户</a><span class="line"></span></li>
