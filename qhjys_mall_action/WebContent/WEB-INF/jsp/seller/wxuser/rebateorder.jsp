...
<div class="membercontent">
	...
	<div class="memberright">
		<div class="member_myorder">
			<form action="/managermall/seller/wxuser/rebateOrder.do" method="post" id="from">
    			<input type="hidden" id="page" name="page">
    			<input type="hidden" id="openId" name="openId" value="${openId }">
    		</form>
			<ul class="menu0" id="menu0">
				<a href="/managermall/seller/wxuser/fqOrder.do?openId=${openId }"><li>预定点餐记录</li></a>
				<a href="/managermall/seller/wxuser/rebateOrder.do?openId=${openId }"><li  class="hover">优惠买单记录</li></a>
			</ul>
						...
						<div class="member_myorder">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<c:forEach items="${page}" var="page">
									...
									<td class="td80">￥${page.realPay }</td>
			                        <td class="td80">￥${page.totamt }</td>
									<td class="td100"><fm:formatDate value="${page.payTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
									</tr>
								</c:forEach>
							</table>
