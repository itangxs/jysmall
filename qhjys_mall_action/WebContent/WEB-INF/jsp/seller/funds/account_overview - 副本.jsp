...
<div class="membercontent">
	...
	<div class="memberright">
        ...
        <form action="/managermall/seller/funds/account/overview.do"  method="post" id="from">
         ...
         <p class="clearfix"  style="position:relative; height:60px;">
	           	<label class="one" for="con-email2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提现：</label>
	           	<input id="tiMoney" class="con-email4" value="" placeholder="输入提现金额" > 元	
                <!--当输入提现金额时出现--><span style="position:absolute; top:30px;left:80px; color:#999; display:none">（提现费用￥10.00元）</span>         
        ...
        <div class="member_myorder">
   	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        		<tr>
                	<th colspan="5" style="font-size:15px;">在线支付结算表</th>
                </tr>
                <tr>
                   <th class="">日期</th>
                    <th>移动支付金额</th> 
                ...
                <c:forEach items="${page }" var="p" varStatus="status">
                	<tr>
						...
						<td style="text-align: center;">￥${p.totalMoney }</td>
				  		...
				  		<c:if test="${p.state == 0 }"><span class="t-fontred">未结算</span></c:if>
				  		<c:if test="${p.state == 1 }"><span class="t-fontblue">已结算</span></c:if>
				  		</td>
                        <td style="text-align: center;">￥0.00</td>
                        <td style="text-align: center;">T+1结算</td>
                	</tr>
                </c:forEach>
            </table>
