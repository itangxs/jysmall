...
<div class="membercontent">
	...
	<div class="memberright">
      ...
      <ul class="menu0" id="menu0">    
            <li onclick="setTab(0,0)" class="hover">充值列表</li>  
            <li onclick="setTab(0,1)">充值申请</li>  
           </ul>  
           <div class="main" id="main0">  
	        ...
	        <div class="page">
             ...
             <ul><li>
              <div class="member_myorder">
            <form id="form1" name="form1" method="post" action="/managermall/seller/funds/account/recharge.do">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                ...
                <tr>
                  <td width="90" style="text-align:right;">当前预存款：</td>
                    <td width="848" class="td509">${cashAccount.balance}</td>
                </tr>
                <tr>
                  <td width="80" style="text-align:right;">支付方式：</td>
                    <td width="848" class="td510" style="text-align:left;">
                    <input name="" type="radio" value="" checked="checked"  />  
                    <img src="/images/lianlianzhifu.png"  width="120" height="32" />
                    </td>
                </tr>
            	<tr>
                  ...
                  <td width="848" class="td509">
	                  <select name="cardNo" id="cardNo" >
		                  <c:forEach items="${bank}" var="b">
		        		  	<option value="${b.bankNumber}">${b.bankNumber}</option>
		        		  </c:forEach>
	            	  </select>
            	  </td>
                </tr>
                <tr>
                  <td width="80" style="text-align:right;">充值元宝：</td>
                    <td width="848" class="td509"><input name="rechargeMoney" type="text" class="con-email3" >&nbsp;</td>
                </tr>
              <tr>
                  <td style="text-align:right; padding-top:10px;">
                    <input type="submit" name="button" id="button" value="充值"  class="submit6" />
                    <input class="submit6" type="hidden" name="token" value="${rechargeToken}" />
                  </td>
                  <td class="td508"></td>
              </tr>
            </table>
