...
<body>
	...
	<div class="membercontent">
		...
		<div class="memberright">
			<form id="from" name="query" method="post" class="zcform1" action="/managermall/seller/fqorder/orderList.do">
				...
				<p class="clearfix">
					<label class="one" for="con-email2">创建订单时间：</label>
					<input id="createTimeBegin" name="createTimeBegin" class="easyui-datebox con-time"  value="${createTimeBegin}">
					<label class="one" for="con-email2">-</label>
					<input id="createTimeEnding" name="createTimeEnding" class="easyui-datebox con-time"  value="${createTimeEnding}"><em class="space"></em>
				</p>
				<p class="clearfix">
			...
			<div class="member_myorder">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<th class="td80">总价</th>
						<th class="td160">订单时间</th>
						<th class="td130">桌号</th>
						<th class="td130">操作</th>
					</tr>
					<c:forEach var="info" items="${page}">
					<tr>
					    <td class="td130">${info.orderNo}</td>
						<td class="td80">￥<fm:formatNumber value="${info.totalAmount}" type="currency" pattern="#,#0.00#"/></td>
						<td class="td160"><fm:formatDate value="${info.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						<td class="td130">${info.deskNo}</td>
						<td class="td130">
							<a href="" style="color:#44b5df">打印</a>&nbsp;
                            <a href="/managermall/seller/fqorder/orderDetail.do?id=${info.id}">详情</a><br />
						</td>
					</tr>
					</c:forEach>
				</table>
