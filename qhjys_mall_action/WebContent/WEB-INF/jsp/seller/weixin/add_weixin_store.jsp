...
<script type="text/javascript" src="/js/wxstoreInfo.js"></script>
			...
			<div id="member_myorder">
				...
				<div id="mainShow" class="main">
					<div class="member_myorder">
						<form id="form" class="zcform" style="margin-left:155px;text-align:left;" method="post" action="/managermall/seller/addWXStoreInfo.do">
							<p class="clearfix">
								<label class="one" for="con-email">微店铺名称：</label> 
								<input name="storename" id="storename" class="con-email" value="">
							</p>
							<p class="clearfix">
								<label class="one" for="con-email">微信店铺LOGO：</label>
								<img id="logoImage" width="150" height="120" src="" alt="" />
								请上传一张440px*300px大小的图片
								<input id="logo" type="hidden" name="storelogo" value="" />
								<br>
								<br>
							</p>
							<p class="clearfix">
							...
							<p class="clearfix">
								...
								<img id="relevantImage1" width="150" height="120" src="" alt="" />
								<input id="relevant1" type="hidden" name="relevantImage1" value="" />
								<br>
								<br>
							</p>
							<p class="clearfix">
							...
							<p class="clearfix">
								...
								<img id="relevantImage2" width="150" height="120" src="" alt="" />
								<input id="relevant2" type="hidden" name="relevantImage2" value="" />
								<br>
								<br>
							</p>
							<p class="clearfix">
							...
							<p class="clearfix">
								...
								<img id="relevantImage3" width="150" height="120" src="" alt="" />
								<input id="relevant3" type="hidden" name="relevantImage3" value="" />
								<br>
								<br>
							</p>
							<p class="clearfix">
							...
							<p class="clearfix">
								...
								<textarea name="storeinfo" id="storeinfo" style="width:200px;height: 100px;max-width: 200px;max-height: 100px" ></textarea>
								字数不可超过150
							</p>
							<!-- <p class="clearfix">
								<label class="one" for="con-email">店铺折扣：</label>
								<input name="storeRebate" id ="storeRebate" class="con-email"  value="">
								请输入1-10之间的数 
							</p> -->
							<!-- <p class="clearfix">
								<label class="one" for="con-email">活动介绍：</label>
								<textarea name="activityinfo" id="activityinfo" style="width:200px;height: 100px;max-width: 200px;max-height: 100px" ></textarea>
								字数不可超过150
							</p> -->
							<p class="clearfix">
								<label class="one" for="con-email">地址：</label>
								<input name="address" id ="address" class="con-email"  value="">
							</p>
							...
							<p class="clearfix">
								...
								<p class="clearfix">
									...
									<div class="input-group date form_time col-md-5"  data-date="" data-date-format="hh:ii" data-link-field="dtp_input3" data-link-format="hh:ii">
						                    <input class="form-control"   name="trafficEndTime" id="trafficEndTime"  size="16"  type="text" value="${fqStore.trafficBeginTime}" readonly>
						                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
						                </div>
							</p>
							...
							<p class="clearfix">
								...
								<input name="phonenum" id="phonenum" class="con-email" value="" maxlength="11">
							</p>
						
							<p class="clearfix">
								<label class="one" for="con-email">定金比例：</label>
								<input name="proportion" id="proportion" class="con-email" value="" >
								%&nbsp;&nbsp;&nbsp;请输入1-100之间的数 
							</p>
							...
							<p class="clearfix">
								...
								<select name="locationid" id="locationid">
									...
									<c:forEach items="${fqLocation}" var="sq">
										<option value="${sq.id}">${sq.location}</option>
									</c:forEach>
								</select>
							</p>
							...
							<%-- <p class="clearfix">
								...
								<c:forEach items="${fqCuisines}" var="cx">
										<option value="${cx.id}">${cx.cuisine}</option>
									</c:forEach>
								</select>
							</p> --%>
							<input type="hidden" name="token" value="${addWeixinStoreToken}" >
							<p class="clearfix">
								<input class="submit22" type="submit" value="提交" style="margin-left:200px;" />
							</p>
						</form>
					</div>
				</div>
