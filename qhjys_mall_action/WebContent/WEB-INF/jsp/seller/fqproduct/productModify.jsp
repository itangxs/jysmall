...
<body>
	...
	<div class="membercontent">
		...
		<div class="memberright">
			<h3 style="padding-left: 10px;">菜品管理——添加菜品</h3>
					...
					<tr>
						<th style="text-align: left; background: #fffef5;">
							<form id="signupForm" method="post"
								action="/managermall/seller/fqproducts/add.do"
								class="zcform" style="margin-left: 160px;">
								<p class="clearfix">
									<label class="one" for="contactname">菜品名称：</label> <input
										id="contactname" class="con-email" name="cpmc" value="${product.productName}"> <span
										id="contactnameTip"></span>
								</p>
								<p class="clearfix">
									<label class="one" for="con-email3">市场价：</label> <input
										id="scj" name="scj" class="con-email3" value="${product.price}" >
									&nbsp;元 <span id="scjTip"></span>
								</p>

								<p class="clearfix">
									<label class="one" for="kc">库存：</label> <input id="kc"
										 value="${product.stock}" name="kc" class="con-email3">&nbsp;个 <span id="kcTip"></span>
								</p>

								<p class="clearfix">
									<label class="one" for="xsyxj">显示优先级：</label> 
									<input id="xsyxj"
										name="xsyxj"  value="${product.level}" class="con-email3">&nbsp;1~99 级<span
										id="xsyxjTip"></span>
								</p>
								...
								<div style="position: relative; display: inline-block;">
									<img id="img1" src="${product.productImages}" width="150" height="120" alt="" /> 
									<input type="hidden" id="img1u" name="imgs" value="${product.productImages}" /><input
								...
								<p class="clearfix">
									<textarea id="cpxx1" style="display: none;">${product.productInfo}</textarea>
