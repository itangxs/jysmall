...
<div class="membercontent">
	...
	<div class="memberright">
		<form action="/managermall/seller/commoditymanage/list.do" method="post" id="from">
         ...
         <div class="member_myorder">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <th class="td130">折扣价</th>
                    <th class="td130">市场价</th>
                    <th class="td130">库存</th>
                    <th class="td130">已销售</th>
                    <th class="td130">评价</th>
                    <th class="td80">操作</th>
                </tr>
            </table>
