...
<body>
	...
	<div class="membercontent">
		...
		<div class="memberright">
			...
			<form id="from" name="query" method="post" class="zcform1" action="/managermall/seller/funds/advancelist.do">
            	...
            	<label class="one" for="con-email2">创建时间${istancc}：</label>
					<input id="startTime" name="startTime" class="easyui-datebox con-time" value="${startTime}" onchange="javascript:changedatenum('')">
					<label class="one" for="con-email2">-</label>
					<input id="endTime" name="endTime" class="easyui-datebox con-time"  value="${endTime}"  onchange="javascript:changedatenum('')">
		...
		<div class="clear"></div>
		<div id="mask-layer" <c:if test="${istanc == 0}"> style="display: none;"</c:if>>
			<div class="mask-layer-content">
				<a href="http://www.jysmall.com/ww-situation.html" target="_blank"><img src="/images/seller/mask-layer-img.jpg"></a>
				<img id="delet-layer" onclick="mask_fadeIn()" src="/images/seller/close_button.png">
			</div>
		</div>
	</div>
