...
<script type="text/javascript" src="/js/seller/schedule/businessOrderlistManage.js"></script>
</head>
<body>
	<jsp:include page="/WEB-INF/jsp/seller/seller_header.jsp"><jsp:param name="val" value="1" /></jsp:include>
	<div class="membercontent">
		<jsp:include page="/WEB-INF/jsp/seller/seller_left.jsp"><jsp:param name="position" value="13" /></jsp:include>
		<!--------------右侧------------------>
		<div class="memberright">	
	        <div id="member_myorder">  
	           <ul class="menu0" id="menu0">    
	            <li onclick="setTab(0,0)" class="hover">未处理订单</li>  
	            <li onclick="setTab(0,1)">已处理订单</li> 
	           </ul>
	           ...
	           <c:forEach items="${sellerScheduleVoList1 }" var="sellerScheduleVo">
	                <tr>
	                    <td class="td160">${sellerScheduleVo.title }</td>
