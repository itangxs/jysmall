...
<script type="text/javascript" src="/js/wap/registration_email.js"></script>
</head>
...
<form method="post" id="registrationForm" method="post" action="/account/wap/saveRegister.do"> 
  <div class="module">
  	<div class="tabs">
  		...
  		<a id="registrationByEmail" href="/account/wap/registrationByEmail.do?recomId=${recomId}&inviteCode=${inviteCode}" class="tabaction">邮箱注册</a>
  		<a id="registrationByTel" href="/account/wap/registrationByTel.do?recomId=${recomId}&inviteCode=${inviteCode}" >手机注册</a>
    ...
    <div class="login" style="display:none;">
        ...
        <div class="login">
        <label class="loginbk"><input  id="email" name="email" type="text" onFocus="if(value=='请输入邮箱'){value=''}" onBlur="if(value==''){value='请输入邮箱'}" class="inputmoney inputtext" value="请输入邮箱"></label>
    ...
    <div class="bottomanniu">
    	...
    	<%-- <input type="hidden" name="recomId" value="${recomId}"> --%>
