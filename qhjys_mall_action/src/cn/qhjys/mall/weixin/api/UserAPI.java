...
import cn.qhjys.mall.weixin.bean.user.FollowResult;
import cn.qhjys.mall.weixin.bean.user.GetblacklistResult;
import cn.qhjys.mall.weixin.bean.user.Group;
import cn.qhjys.mall.weixin.bean.user.TagsCreatResult;
import cn.qhjys.mall.weixin.bean.user.TagsGetResult;
import cn.qhjys.mall.weixin.bean.user.TagsGetidlistResult;
import cn.qhjys.mall.weixin.bean.user.User;
import cn.qhjys.mall.weixin.bean.user.UserInfoList;
import cn.qhjys.mall.weixin.bean.user.UserTagGetResult;
